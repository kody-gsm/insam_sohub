...
from logic._grpc.protos import Image_db_pb2 as logic_dot___grpc_dot_protos_dot_Image__db__pb2
...
class ImageTrafficStub(object):
    ...
    def __init__(self, channel):
        ...
        self.image_create = channel.unary_unary(
                ...
                request_serializer=logic_dot___grpc_dot_protos_dot_Image__db__pb2.CertifiedImage.SerializeToString,
        ...
        self.image_read = channel.unary_unary(
                ...
                request_serializer=logic_dot___grpc_dot_protos_dot_Image__db__pb2.CertifiedImage.SerializeToString,
                response_deserializer=logic_dot___grpc_dot_protos_dot_Image__db__pb2.ResponseImage.FromString,
                )
...
def add_ImageTrafficServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'image_create': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=logic_dot___grpc_dot_protos_dot_Image__db__pb2.CertifiedImage.FromString,
            ...
            'image_read': grpc.unary_unary_rpc_method_handler(
                    servicer.image_read,
                    request_deserializer=logic_dot___grpc_dot_protos_dot_Image__db__pb2.CertifiedImage.FromString,
                    response_serializer=logic_dot___grpc_dot_protos_dot_Image__db__pb2.ResponseImage.SerializeToString,
            ),
...
class ImageTraffic(object):
    ...
    def image_create(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/ImageTraffic/image_create',
            logic_dot___grpc_dot_protos_dot_Image__db__pb2.CertifiedImage.SerializeToString,
    ...
    def image_read(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/ImageTraffic/image_read',
            logic_dot___grpc_dot_protos_dot_Image__db__pb2.CertifiedImage.SerializeToString,
            logic_dot___grpc_dot_protos_dot_Image__db__pb2.ResponseImage.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
